...
def get_not_duplicated_three_digit_number():
    ...
    while 1:
        ...
        if is_validated_number(str(result)) == True:
            break
        else:
            continue
    # ==================================
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    strikes_ball = [0,0]
    # user_input_number = set(user_input_number)
    ...
    while finish_1:
        ...
        while finish_2:
            ...
            if user_input == "0":
                ...
                strikes_ball = get_strikes_or_ball(user_input, random_number)
                print("Strikes :",strikes_ball[0],",","Balls :",strikes_ball[1])
                if strikes_ball == [3,0]:
                    while finish_2:
